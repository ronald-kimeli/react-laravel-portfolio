                ...
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <div className="resume-item pb-0">
                            <h4>Ronald Kimeli</h4>
                            <p><em>Innovative and deadline-driven Full Stack web developer with 2+ years of experience designing and developing user-centered websites from initial concept to final, polished deliverable.</em></p>
                            <p>
                            </p><ul>
                                <li>Nairobi, Kenya</li>
                        ...
                        <div className="resume-item">
                            ...
                            <h5>2016 - 2020</h5>
                            <p><em>University of Kabiangay, Kericho, Kenya</em></p>
                            <p>Software Engineering specialization</p>
                        </div>
                        <div className="resume-item">
                            <h4>HTML5 and CSS3 online Certification</h4>
                            <h5>2022 - 2022</h5>
